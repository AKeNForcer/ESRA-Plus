...
from models.gpl.gpl.toolkit.sbert import load_sbert
...
class GplTsdae:
    def __init__(
        ...
        model_name_or_path="./models/gpl/TSDAE/500000",
        embedding_path='./models/gpl/embedding/TSDAE',
        corpus_path='./models/gpl/arxiv2/corpus.jsonl',
        device='cuda'
    ):
