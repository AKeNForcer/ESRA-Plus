...
export const SearchComponent = () => {
  ...
  return <>
    <div className='h-[400px] w-full max-w-[700px] text-base'> {/*absolute inset-y-[345px]  z-20*/}
      <div className={`flex-col h-12 w-full items-center bg-transparent rounded-3xl border-[1px] border-gray-300 relative z-20 ${completion.length > 0 ? '' : 'focus-within:shadow-md'}`}>
      ...
      {
        completion.length > 0 ?
          <div className="w-full shadow-md text-left relative -inset-y-[48px] z-10 rounded-3xl border-[1px] border-gray-300">
